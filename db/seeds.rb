...
product5 = Product.create!(user: user3,
...
product6 = Product.create!(user: user3,
...
product7 = Product.create!(user: user2,
...
product8 = Product.create!(user: user3,
...
product9 = Product.create!(user: user1,
...
product10 = Product.create!(user: user3,
...
product11 = Product.create!(user: user2,
...
product12 = Product.create!(user: user1,
                            name: "Cesto Cunho 45 cm Etnia Mehinako - Xingú",
...
product13 = Product.create!(user: user3,
...
product14 = Product.create!(user: user2,
...
product15 = Product.create!(user: user1,
